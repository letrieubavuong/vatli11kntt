...
src_dir = r"C:\Users\ThayVuongNTK\Documents\GitHub\vatli11kntt"
...
src_public = os.path.join(src_dir, "public", "images")
dest_public = os.path.join(dest_dir, "public", "images")
if os.path.exists(src_public):
    copy_overwrite_dir(src_public, dest_public)
    print("Synced public/images directory.")
