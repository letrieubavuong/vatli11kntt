...
\begin{align*}
\boder{\Delta d=d_2-d_1=\dfrac{ax}{D}}
\end{align*}
Trong đó
\begin{itemize}
...
\paragraph{Vị trí (tọa độ) của vân tối ($\Delta d=\pbrace{k+0,5}\lambda$)}
\begin{align*}
...
\end{cases}
\end{align*}
\paragraph{Điều kiện giao thoa}
Điều kiện để có giao thoa là hai nguồn sáng phải là hai nguồn kết hợp 
\begin{align*}
\begin{cases}
\ct{Cùng phương}\\
