...
\end{ex} \haidong{20}
\begin{ex}
Cho các nhận định sau về động năng và thế năng của một vật dao động điều hòa.
\choiceTF[t]
...
\choiceTF[t]
{\True Đồ thị biểu diễn mối quan hệ giữa thế năng và li độ là một đường parabol}
{Đồ thị biểu diễn mối quan hệ giữa động năng và thế năng là một đường hình sin}
{\True Đồ thị biểu diễn mối quan hệ giữa động năng và li độ là một đường parabol}
{\True Đồ thị biểu diễn mối quan hệ giữa động năng và cơ năng là một đoạn thẳng}
\loigiai{
\begin{itemchoice}
\itemch
\itemch
