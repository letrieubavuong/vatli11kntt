...
{15,45 m/s}
{4,54 m/s}
}{\begin{tikzpicture}[scale=0.7,thick,>=stealth',rotate=-90]
\draw[very thick] (0,-0.5)--(0,0.5)(4.5,-0.5)--(4.5,0.5);
\draw [red,line width = 1.2pt, domain=0:4.5, samples=500]%
...
\begin{ex}%CTST
\immini[thm]{
Hiện tượng sóng dừng có thể xảy ra đối với sóng điện từ và có nhiều ứng dụng trong cuộc sống. Ví dụ trong lò vi sóng (lò vi ba), sóng điện từ được phản xạ trên các thành lò và tạo thành sóng dừng trong lò. Tại những bụng sóng, năng lượng của sóng điện từ có giá trị lớn nhất và cung cấp nhiệt cho thực phẩm (từ sự dao động của các phân tử nước trong thực phẩm). Do đó, trong lò vi ba còn có đĩa quay để giúp thực phẩm nóng đều}{\includegraphics[width=4cm]{Hinh/CT913}}
...
\begin{center}
\includegraphics[width=8 cm]{images/2025_04_24_3fa78bcd461b729bcc97g-4}
\end{center}
\choiceTF[t]
