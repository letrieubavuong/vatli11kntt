...
\Textbox{0.6}{\centering
\begin{tikzpicture}[x=(0:1.2), y=(90:1.0), z=(-150:1.0),
...
\draw[fill=black](a)++(-90:0.15)--++(-38:0.43)--++(0:1.2)--++(-45:0.1)--++(-90:0.05)--++(150:0.08)--++(180:1.2)--++(150:0.38)--cycle;
\draw[fill=black](a)++(-90:1)--++(35:0.42)--++(90:0.05)--++(-155:0.37);
\draw(b)--(f)(c)--(d);
\foreach \x in {1.63,1.93,...,3.7}
\foreach \y in {-1.925}
{\draw[fill=black,very thin](\x,\y)--++(60:0.1)--++(-60:0.1)--++(-75:0.35)--++(-120:0.1)--++(120:0.1)--cycle;
\draw[fill=white,very thin](\x,\y)--++(60:0.1)--++(-80:0.5)--cycle;
}
\draw[fill=black,very thin](3.68,-1.96)--++(60:0.05)--++(-60:0.06)--++(-75:0.25)--++(-120:0.05)--++(120:0.05)--cycle;
\draw[fill=white,very thin](3.68,-1.96)--++(60:0.05)--++(-78:0.34)--cycle;
\draw[fill=black,very thin](3.85,-2.01)--++(60:0.05)--++(-60:0.06)--++(-75:0.15)--++(-120:0.05)--++(120:0.05)--cycle;
...
\paragraph{Tính chất của sóng điện từ}
\begin{itemize}
\item Sự lan truyền sóng điện từ:
\begin{itemize}
\item Sóng điện từ lan truyền được trong chân không với tốc độ bằng tốc độ ánh sáng \bth{(c\approx3.10^{8}\ m/s)}. 
\item Sóng điện từ lan truyền được trong các môi trường khác với tốc độ $v=\dfrac{c}{n}$ với n là chiết suất môi trường. 
\end{itemize}
\item Sóng điện từ là sóng ngang. Trong quá trình lan truyền, vector cường độ điện trường \bth{\vec{E}} và vector cảm ứng từ \bth{\vec{B}} luôn luôn vuông góc với nhau và vuông góc với phương truyền sóng. 
...
\paragraph{Bước sóng của sóng điện từ}
Bước sóng điện từ trong chân không: $\boder{\lambda=\dfrac{c}{f}}$ 
\paragraph{Tầng điện li}
\notebox{
...
\node[inner sep=0pt] (russell) at (o){\includegraphics[width=10cm]{Hinh/Earth1}};
\node[inner sep=0pt] (russell) at (a){\includegraphics[width=1.5cm]{Hinh/satellite.pdf}};
\node[inner sep=0pt,rotate=30] (russell) at (b){\includegraphics[width=0.8cm]{Hinh/Rada2}};
\node[inner sep=0pt,rotate=-30] (russell) at (c){\includegraphics[width=0.8cm]{Hinh/Rada1}};
\node[inner sep=0pt,rotate=40] (russell) at (d){\includegraphics[width=0.5cm]{Hinh/CotPhatSong}};
\node[inner sep=0pt,rotate=-40] (russell) at (e){\includegraphics[width=0.5cm]{Hinh/CotPhatSong}};
