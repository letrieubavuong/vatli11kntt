...
\begin{enumEX}[1.]{2}
\item Chu kì dao động của thuyền là \dotfill
\item Tốc độ lan truyền của sóng là \dotfill
\item Bước sóng là \dotfill
\item Biên độ sóng là \dotfill
\end{enumEX}
\loigiai{
\begin{itemize}
...
\begin{enumEX}[1.]{2}
\item Tốc độ truyền sóng là ..........
\item Bước sóng  là ..........
\item! Nếu tần số sóng là 442 Hz thì bước sóng  là .......... và chu kì là ..........
\end{enumEX}
\loigiai{
\begin{itemize}
...
{\True 2}
{4}
{0,5}}{\begin{tikzpicture}[draw=Mapcolor,scale=1,thick,>=stealth',x=0.4cm,y=0.4cm]
\tkzDefPoints{0/0/o, 12/0/x, 0/7/i}
\draw[Mapcolor,very thick] plot [smooth,tension=1] coordinates{(0.5,6)(3.5,2) (11,0.6)};
\draw[Mapcolor,very thick] plot [smooth,tension=1] coordinates{(0.5,3.5)(3.5,1) (11,0.3)};
