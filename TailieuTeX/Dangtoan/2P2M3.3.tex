...
%\end{itemize}
%\end{itemize}}{\begin{tikzpicture}[draw=Mapcolor, very thick]
%\tkzDefPoints{0/0/a, 4/0/b, 1/2/n, 2.2/2.5/m}
%\tkzDrawSegments[dashed,Mapcolor, very thick](a,b a,m b,m a,n b,n)
...
%\draw[red] plot[domain=-2:2] ({-1*cosh(\x)-0.5},{1.01*sinh(\x)});
%\draw[red](0,3)--(0,-3);
%\draw[Mapcolor!50](s1)--(s2);
%\tkzLabelPoint[left](s1){$A$}
%\tkzLabelPoint[right](s2){$B$}
%\tkzDrawCircle[diameter,color=Mapcolor!50](m,n)
