...
\end{itemize} }{\begin{tikzpicture}[scale=1,draw=Mapcolor, very thick,>=stealth']
\fill [pattern = north east lines,pattern color=Mapcolor] (8,-0.4) rectangle (8.2,0.4);
\fill [pattern = north east lines,pattern color=Mapcolor] (8,-2.2) rectangle (8.2,-1.3);
...
\end{itemize}
\begin{center}
\begin{tikzpicture}[scale=0.9,draw = Mapcolor, very thick,>=stealth',x=1.1cm]
