...
def compile_tikz_to_svg(tikz_code, lesson_id, index):
    ...
    dest_dir = "C:/Users/ThayVuongNTK/Documents/GitHub/vatli11kntt/public/images/tikz"
    ...
    if not os.path.exists(images_scratch):
        try:
            real_images_dir = r"C:\Users\ThayVuongNTK\Documents\GitHub\vatli11kntt\public\images"
